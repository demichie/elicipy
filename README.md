...
1. Go to the Elicipy repository (https://github.com/demichie/elicipy) and create a copy of the repository by clicking on the green button "Use this template", on the top-right.
